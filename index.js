...
function get20s(artists){
  ...
  if(artists[i].years.split(" ")>="1900-2000"){
    livedFrom.push(artists[i].years);
}
...
console.log(addArtist(20, 'Trevor Mandina', '1998 - 2021', 'Web Design', 'White', 'lorem ipsum kity delor'));
...
function lotsOfArt(artists){
  ...
  if (artists[i].paintings>100){
    hundredArtists.push(artists[i].name);
  }
}
